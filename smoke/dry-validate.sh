...
if [ -f "$SJ" ]; then
  ...
  # C1-гард: double-slash в permissions = glob не матчит реальные пути → щит секретов мертв.
  # homeDir absolute; ведущий '/' в шаблоне дает Read(//Users/...) — навсегда ловим здесь.
